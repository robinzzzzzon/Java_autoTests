...
public class FiltersFragmentSteps {

    private CountryFiltersFragmentPage page;
    ...
    @Step
    public void putAnyPrice(boolean b, String anyPrice) {
        page.putAnyPriceInPriceInput(b, anyPrice);
    }
